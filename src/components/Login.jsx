  ...
  return (
    <div className=" w-full h-full">
      <div className="relative">
        ...
        <div className="text-white flex flex-col gap-8 rounded-lg absolute top-[20%] h-4/6 w-2/6 left-[35%] py-8 px-12  bg-opacity-60">
          <h2 className="text-white text-4xl z-20">Sign In</h2>
          <form onSubmit={(e) => e.preventDefault()} className="space-y-6">
            <input
              ref={email}
              className="border-gray-400 border rounded-lg font-medium text-white bg-transparent p-4 py-6 w-full"
              placeholder="Email"
              type="email"
            />
            <input
