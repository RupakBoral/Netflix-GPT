  ...
  return (
    <div className="overflow-x-hidden">
      <div className="relative">
        ...
        <div className="absolute inset-0  opacity-60 h-full"></div>
      </div>
      ...
      <div className="flex gap-4 z-10 absolute top-[70%] left-[35%] text-center text-white">
        <input
          ...
          className="bg-transparent font-medium border border-gray-400 py-3 px-3 w-96"
          type="email"
          placeholder="Email Address"
        />
        <div className="flex flex-grow gap-4 items-center justify-center bg-red-600 hover:bg-red-700 h-full rounded-md">
          <Link to={"/signUpStep1"} onClick={handler}>
            <button className="py-3 px-6 text-white font-bold">
              Get Started
            </button>
          </Link>
          <svg
      ...
      <div className="flex items-center absolute top-[80%] left-[45%] gap-6">
        ...
        <Link to={"/login"}>
          <button className="text-white bg-red-600 hover:bg-red-700 rounded-md px-6 py-3">
            Login
          </button>
        </Link>
      </div>
